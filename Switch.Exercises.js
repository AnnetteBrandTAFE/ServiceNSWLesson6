    ...
    if (custAge < 15) {
        ...
        switch(ans) {
            case "1":
                ...
                let noOfTickets1 = parseInt(userInput2);
                console.log(`You have selected to purchase ${noOfTickets1} tickets to Star Trek II : The Wrath of Khan. Your total for your tickets is $ ${noOfTickets1 * 15}`);
                console.log();
                break;
            case "2":
                console.log();
                console.log("You have selected The Enforcer starting Clint Eastwood");
                let userInput3 = await askQuestion("How many tickets would you like ");
                let noOfTickets = parseInt(userInput3);
                console.log(`You have selected to purchase ${noOfTickets2} tickets to The Enforcer staring CLINT EASTWOOD. Your total for your tickets is $ ${noOfTickets2 * 15}`);
                console.log();
                break;
            case "3":
                ...
                break;
            default:
                console.log("Your selection was not recognised. Please enter a number from 1-3");
                break;
            } 
    }
let drinks = []
...
console.log();
let UserInput4 = await askQuestion("Please enter your favourite soft drink: ");
drinks.push(UserInput4);
console.log();
